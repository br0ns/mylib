...
signature Sequence = sig
  include MonadP
  include Foldable
  include Enumerable where type 'a enumerable_element = 'a
  include Unfoldable where type 'a unfoldable_element = 'a
  include SequenceExt
  sharing type alt = monad = foldable = enumerable = unfoldable = sequence
end
